...
private:
  ...
  public:
      ...
      bool operator()(const Pair_type& one, const Pair_type& two) const {
          return Key_compare()(one.first, two.first);
      }
  };
...
public:
  ...
  {
      auto found_it = entries.find({ k, Value_type() });
